...
test("complex units",(t)=>{
    ...
    //compareComplexUnit(t,'3ft / (1 ft/s) as second',new Literal(3).withComplexUnitArray(['second',1],[])),
    //compareComplexUnit(t,'3ft / (1 ft/min) as second',new Literal(3*60).withComplexUnitArray(['second',1],[])),
    //compareComplexUnit(t,'1m / 1ft/s', new Literal(1*3.28).withComplexUnitArray(['second'])),
    ...
    //compareComplexUnit(t,'4000mi / (4000 ft/second)',new Literal(5256).withComplexUnitArray(['second'],[]));
    //compareComplexUnit(t,'4000mi / (2727 mi/hr)',new Literal(1.46).withComplexUnitArray(['hour'],[]));
    //compareComplexUnit(t,'earth.radius / 4000 m/s as hours',new Literal(1).withUnit('hour'));
